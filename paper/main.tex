...
They do not: the best shifted-split $F_1$ occurs at $\lambda=0$ (S: $0.617$; L: $0.612$)
and increasing $\lambda$ reduces it (S at $\lambda=1$: $0.534$). Erasing a genuinely
...
The authors thank Prof.\ Deepali Patil for her guidance and mentorship, and the Department
of Artificial Intelligence and Data Science, SVKM's Dwarkadas J. Sanghvi College of
Engineering, Mumbai, for the support and computational resources that made this study
possible. Code, the split and leakage-purging scripts, and the scripts that regenerate every
table and figure from the experiment outputs are at
\url{https://github.com/WinterBlossom0/IPD-IDS}; the dataset itself is redistributed by the
